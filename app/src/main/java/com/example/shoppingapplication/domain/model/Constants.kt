...
object Constants {
    const val shoppingDetailedKey = "SHOPPING_DETAILED_KEY"
    val categoriesHardCoded = listOf(
        ...
        Category(
            id = 2,
            name = "jewelery",
            description = "Read and grow your knowledge",
            "https://c8.alamy.com/comp/B07E57/expensive-jewellery-in-a-shop-window-on-ponte-vecchio-florence-B07E57.jpg"
        ),
        Category(
            id = 3,
            name = "men's clothing",
            description = "Latest Men trends in fashion",
        ...
        Category(
            ...
            description = "Latest Women trends in fashion",
            "https://as2.ftcdn.net/jpg/01/19/88/81/240_F_119888114_8xcTup3TuyQATE1DWH8Ii6RZUYBwyvJx.jpg"
        )
